...
var submitForm = function (formData) { return __awaiter(_this, void 0, void 0, function () {
    var response, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, fetch("https://67176272b910c6a6e027d621.mockapi.io/users", {
                        method: "POST",
                        headers: {
...
contactForm.addEventListener("submit", function (event) {
    ...
    var formData = { name: name, email: email, contact: contact, subject: subject, message: message };
    submitForm(formData);
});
